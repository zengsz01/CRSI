...
// problem generator
#define PROBLEM_GENERATOR "gyro_resonance_2d"
...
// include particles? default=0 (false)
#define PARTICLES 2
#define DUST_PAR 1
#define CHARGED_PAR 2
...
// gperftools macros (GPERFTOOLS or NON_PROFILER_OPTION)
#define NON_PROFILER_OPTION
