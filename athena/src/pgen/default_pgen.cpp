...
//========================================================================================
//! \fn void Particles::UserWorkInLoop()
//  \brief Function called once every time step for user-defined work.
//========================================================================================

void __attribute__((weak)) Particles::UserWorkInLoop() {
  // do nothing
  return;
}

//--------------------------------------------------------------------------------------
//! \fn void Particles::AnalysisOutput(Real *spec, const int &ntbin, const int
//! &npbin, const Real &dpbin_inv, const Real &ln_p_min) const

void __attribute__((weak))
Particles::AnalysisOutput(Real *spec, const int &ntbin, const int &npbin,
                          const Real &dpbin_inv, const Real &ln_p_min) const {
  return;
}
