...
//----------------------------------------------------------------------------------------
//! \class BinOutput
//  \brief derived OutputType class for particle binary dumps

class BinOutput : public OutputType {
 public:
  explicit BinOutput(OutputParameters oparams) : OutputType(oparams) {}
  void WriteOutputFile(Mesh *pm, ParameterInput *pin, bool flag) override;
};
